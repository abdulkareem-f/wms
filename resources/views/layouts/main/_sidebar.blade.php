...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{url('/')}}" class="brand-logo">
            <img alt="logo" src="{{asset('img/logo.png')}}" class="max-h-40px" />
            <span class="text-white font-size-h2 logo ml-5 lh-2">WMS</span>
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
            ...
            <ul class="menu-nav">
                <li class="menu-item {{ Request::is('/') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{url('/')}}" class="menu-link">
                        <span class="menu-icon fas fa-chart-pie"></span>
                ...
                <li class="menu-item {{ ( Request::is('items') || Request::is('items/create') || Request::is('items/*/edit')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
