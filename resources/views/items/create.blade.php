...
@section('title', 'Items - Add Item')

@section('content')

<form id="item-form" method="post" action="{{ url('items') }}">
    @csrf
	<div class="card card-custom">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-6">
	                <div class="form-group">
	                    ...
	                    <input type="text" name="manufacturer" id="manufacturer" class="form-control @error('manufacturer') is-invalid @enderror" autocomplete="off">
	                    @error('manufacturer')
	                    	<div class="fv-plugins-message-container">
	        ...
	        <div class="row">
	            <div class="col-md-6">
	                <div class="form-group">
	                    ...
	                    <input type="number" name="quantity" id="quantity" maxlength="5" class="form-control @error('quantity') is-invalid @enderror" autocomplete="off">
	                    @error('quantity')
	                    	<div class="fv-plugins-message-container">
	            ...
	            <div class="col-md-6">
	                <div class="form-group">
	                    ...
	                    <input type="text" name="expiry_date" id="expiry_date" readonly class="form-control @error('expiry_date') is-invalid @enderror" autocomplete="off">
	                    @error('expiry_date')
	                    	<div class="fv-plugins-message-container">
		...
		<div class="card-body">
			<table id="units-table" class="table table-bordered table-responsive-md">
			    ...
			    <tbody>
			        <tr>
			            <th class="text-center pt-5">1</th>
			            <td>
			            	<div class="form-group mb-0">
				            	<input type="text" name="unit-name[]" class="unit-name form-control" data-name="unit-name">
				            </div>
			            </td>
			            <td>
			            	<div class="form-group mb-0">
			            		<input type="number" name="unit-buy-price[]" class="unit-buy-price form-control" data-name="unit-buy-price">
		            		</div>
			            </td>
			            <td>
			            	<div class="form-group mb-0">
			            		<input type="number" name="unit-sell-price[]" class="unit-sell-price form-control" data-name="unit-sell-price
			            		">
			            	</div>
			            </td>
			            <td></td>
